...
public class JugadorController {
    ...
    @PostMapping public ResponseEntity<Jugador> registrar(@RequestBody Jugador j) {
        return ResponseEntity.ok(service.registrar(j));
    }
    @PutMapping("/{id}") public ResponseEntity<Jugador> actualizar(@PathVariable Long id, @RequestBody Jugador j) {
    ...
    @PostMapping("/{id}/mazos") public ResponseEntity<MazoPreferido> agregarMazo(
            @PathVariable Long id, @RequestBody MazoPreferido mazo) {
